class Ship {
  ...
  draw() {
    ...
    /* GESTURE INTEGRATION - call functions in gestures.js
    setup()
    ...
    */
    ...
    // if ((getA)) {  // alternative gesture control
...
globals Counter, StarField, Gas, Ship, ADD, ALT, ARROW, AUDIO, AUTO, AXES, BACKSPACE, BASELINE,
